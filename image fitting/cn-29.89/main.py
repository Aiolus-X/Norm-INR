...
parser.add_argument("-ld", "--logdir", help="Path to save logs", default="./log")
...
parser.add_argument("-se", "--seed", help="Random seed", type=int, default=3407)
...
for i in range(min_id, max_id + 1):
    ...
    # Load image
    img = imageio.imread(f"../test-images/lena.png")
